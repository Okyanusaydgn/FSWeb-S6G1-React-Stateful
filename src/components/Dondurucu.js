...
import React, {useState} from 'react'; /* STEP 0 */ // buradaki amaç react da bulunan tüm hook lardan sadece "{useState}" i import et anlamına gelir.
...
const [döndürücüAçık, setdöndürücüAcik] = useState(true)
  ...
  return (
    <div className='widget-spinner container'>
      <h2>Döndürücü</h2>
      {
        döndürücüAçık && <div id='döndürücü' className='spinner'>--+--</div> /* ADIM 2 */  // Buradaki anlamı döndürücüAçık= true ise "&&" bundan sonraki kodu çalıştıracaktır. Eğer döndürücüAçık =false ise bu kod çalışmayacak aşağıdaki toogleDondurucu ya geçecek.Biz direk yukarıdaki h2 yi göreceğiz.
        // yapısından sonra or(||) yapsında ise "true" ifadesini bulana kadar devam eder ama && bu yapıda false gördüğü zaman orada keser.  
      }
